...
export const orders = mysqlTable(
  "orders",
  {
    ...
    shippingFee: decimal("shipping_fee", { precision: 10, scale: 2 }).default(
      "0"
    ),
...
export const mediaAds = mysqlTable("media_ads", {
  ...
  type: mysqlEnum("type", ["banner", "video", "slider", "hero"]).default(
    "banner"
  ),
...
export const dropshippingSuppliers = mysqlTable("dropshipping_suppliers", {
  ...
  category: varchar("category", { length: 150 }).default(
  ...
  status: mysqlEnum("status", ["active", "pending", "inactive"]).default(
    "active"
  ),
  notes: text("notes"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
...
export const dropshippingSupplierProducts = mysqlTable(
  "dropshipping_supplier_products",
  {
    ...
    status: mysqlEnum("status", ["available", "out_of_stock", "draft"]).default(
      "available"
    ),
    approvedProductId: bigint("approved_product_id", {
      mode: "number",
      unsigned: true,
    }),
...
export type DropshippingSupplierProduct =
  typeof dropshippingSupplierProducts.$inferSelect;
...
export const inventoryMovements = mysqlTable("inventory_movements", {
  ...
  supplierProductId: bigint("supplier_product_id", {
    mode: "number",
    unsigned: true,
  }),
  type: mysqlEnum("type", [
...
export const invoices = mysqlTable("invoices", {
  ...
  status: mysqlEnum("status", ["draft", "issued", "paid", "cancelled"]).default(
    "issued"
  ),
...
export const returnRequests = mysqlTable("return_requests", {
  ...
  refundAmount: decimal("refund_amount", { precision: 12, scale: 2 }).default(
    "0"
  ),
...
export const abandonedCarts = mysqlTable("abandoned_carts", {
  ...
  status: mysqlEnum("status", ["pending", "recovered", "ignored"]).default(
    "pending"
  ),
